...
/**
 * Submenu to draw single three-dimensional axes sets.
 * @author Louis Racette
 *
 */
public class subGUIsing3d extends JPanel implements ActionListener {
	protected JFrame selectFrame = new JFrame("Select three dimensions");
	...
	public subGUIsing3d()
	{
		...
		comboPanel.add(rotatePanel,BorderLayout.NORTH);
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if ("close".equals(e.getActionCommand()))
		{
			...
			if((paintMethods3d.slice == true)&&(NDimensionalObject.NumberOfDimensions > 3))
			{
